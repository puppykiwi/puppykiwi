...
#  Tech Stack:
## Languages:
![](https://skillicons.dev/icons?i=python,c,cpp,nodejs,html,css,php,flask,markdown,bash)
## Tools:
![](https://skillicons.dev/icons?i=linux,arduino,raspberrypi,docker,git,mysql,vscode,nginx)
#  GitHub Stats:
